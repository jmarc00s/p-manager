<template>
  <div>
    ...
    <b-modal id="adicionar-sprint" title="Adicionar sprint">
      <b-form @submit="submeterDadosSprint">
        <b-form-group>
          <b-form-input
            placeholder="Número da sprint"
            v-model.number="adicinarSprintForm.numeroSprint"
            type="text"
            required>
...
export default {
  methods: {
    ...
    submeterDadosSprint() {
      console.log(this.adicinarSprintForm);
    }
  },
  data() {
    return {
